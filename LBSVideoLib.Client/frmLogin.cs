...
namespace LBFVideoLib.Client {
  public partial class frmLogin : Form {
    ...
    private void lblContact_Click(object sender, EventArgs e) {
      MessageBox.Show("In case of any query, feedback or if you have forgot your password \n Contact: info@lbf or call on +91 0 9109138808","Contact",MessageBoxButtons.OK,MessageBoxIcon.Information);
    }
  }
}
